  ...
  return (
    <section
      ...
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <div className="flex justify-between md:justify-start items-start flex-wrap w-full mt-20 gap-16 max-sm:gap-6">
          {statistics.map((stat) => (
            <div key={stat.label}>
              <p className="text-4xl max-sm:text-[36px] font-palanquin font-bold">{stat.value}</p>
